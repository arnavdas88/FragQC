...
from benchmark.circuits.cutqc.hwea import HWEA
from benchmark.circuits.cutqc.qft import QFT
from benchmark.circuits.cutqc.walk import QWALK
from benchmark.circuits.cutqc.vqe import UCCSD

qwalk = QWALK(8)
qwalk.gen_coloring()

circuit_list = [
    # HWEA(8, 1).gen_circuit(),
    # QFT(8, .7).gen_circuit(),
    qwalk.gen_circuit(),
    UCCSD(8, 'seeded', 1234).gen_circuit()
]
